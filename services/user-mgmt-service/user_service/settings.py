...
SECRET_KEY = 'django-insecure-px=dz(=)(h$*_dj2qu*(*u$72^rw-132^y0k5_g=!iwod!md5$'
...
# Load the private and public keys from the files
...
SIMPLE_JWT = {
    'ALGORITHM': 'RS256',  # <- You need to add this!
